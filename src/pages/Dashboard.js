...
const columns = [
  ...
  { title: "Product Count", dataIndex: "product" },
  { title: "Total Price", dataIndex: "price" },
  { title: "Total Price After Discount", dataIndex: "dprice" },
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    setDataMonthlySales(orderCountData);

    const ordersArr = [];
    orderState?.forEach((order, i) => {
      ordersArr.push({
        key: i,
  ...
  return (
    <div className="container my-1">
      ...
      <div className="row g-3">
        ...
        <div className="col-md-6">
          <div className="bg-white p-4 rounded shadow-sm">
            ...
            <h4 className="fw-bold">
              Total:{yearlyDataState && yearlyDataState[0]?.count}
            </h4>
            <p className="text-end text-muted mb-0">
      ...
      <div className="row mt-4">
        <div className="col-md-6">
          <div className="bg-white p-4 rounded shadow-sm">
            <h5 className="mb-3">Income in Last Year from Today</h5>
            <Column {...config} />
          </div>
        </div>
        <div className="col-md-6">
          <div className="bg-white p-4 rounded shadow-sm">
            <h5 className="mb-3">Sales in Last Year from Today</h5>
            <Column {...config2} />
          </div>
        </div>
      </div>
